        ...
        <section className="home">
            ...
            <section className="profile" id="profile">
                <div className="box-container">
                    ...
                    <div className="box">
                    <img src="image/about/Ren-pfp.png" alt="Desenho estilizado de pessoa branca de cabelos roxos-lilás grandes e olhos e sobrancelhas roxas. Tem um pequeno sorriso no rosto e usa uma roupa branca com um laço envolta do colarinho, segurando amarantos roxos." />
                        <h1>Ren</h1>
                        <h4>Moderadora</h4>
                    ...
                    <div className="box">
                    <img src="image/about/Aloy-pfp.jpg" alt="Desenho estilizado de pessoa branca de cabelos loiros longos e um lacinho preto com roupa preta enquanto segura um livro vermelho com expressão surpresa." />
                        <h1>Aloy</h1>
                        <h4>Artista</h4>
                    ...
                    <div className="box">
                    <img src="image/about/Chini-pfp.jpg" alt="Desenho estilizado de pessoa com cabelos pretos com mechas brancas na frente, de lado, com óculos redondos e finos e uma expressão alegre. Usa uma roupa preta sem mangas." />
                        <h1>Chini</h1>
                        <h4>Moderadora</h4>
                    ...
                    <div className="box">
                    <img src="image/about/Wraith-pfp.png" alt="Desenho estilizado de pessoa branca de cabelos pretos longos com um fundo muito vermelho. Um de seus olhos é cicatrizado e usa uma roupa vermelha com ombreiras grandes e segura uma máscara de teatro feliz." />
