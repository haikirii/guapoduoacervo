...
const Sobre = () =>{
    return(
        ...
        <section class="home">
            ...
            <p>Para pedir que sua história ou fanart sejam disponibilizadas no site, preencha este <button class= "button"><a href="https://form.jotform.com/242343658304051">formulário.</a></button></p>
